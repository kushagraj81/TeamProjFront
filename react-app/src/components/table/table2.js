...
export const TableProfile2 = (props) => {
 ...
 console.log(user1);
  useEffect(() => {
    ...
    axios.get(`http://localhost:8080/profile/${user1.id}/trades`,{headers: {
 ...
 const [year,setYear]=useState('all')
  const columns = [
    { title: "SecurityID", field: "security.id" },
    {title: "Issuer", field:"security.issuer"},
    {title: "Maturity Date", field:"security.maturitydate"},
    {title: "Coupon", field:"security.coupon"},
    {title: "Type", field:"security.type"},
...
setFilteredData(year==='all'?empList:empList.filter(dt=>dt.year===year))
  ...
  return (
     ...
     <div className="Pets">
      <h2 align="center" style={{marginBottom:'40px'}}>List of Securities</h2>
